...
# specify the recording file you want to convert
...
def sub_time_data(data, start_time, end_time, sampling_rate):  # Gets time axis and data of specific times.
    ...
    time_axis = linspace(start_time, end_time, (int((end_time - start_time) * sampling_rate)))
...
# crop the datafile by start and end times specified
...
# specify the time of the recording
session_start_time = datetime(2024, 1, 26, 12, 51, 17, tzinfo=None)

# Make the initial NWB file and it's parameters
nwbfile = NWBFile(
...
## This section adds the raw data
